...
function editItem(e) {
  ...
  if (e.target.classList.contains('fa-edit')) {
    ...
    itemNormalPrice.value = e.target.parentElement.parentElement.getAttribute(
      'data-item-normal-price'
    );
    itemOfferPrice.value = e.target.parentElement.parentElement.getAttribute(
